...
var S2 = (function () {
    ...
    S2.IEEEremainder = function (f1, f2) {
        var r = Math.abs(f2 % f2);
 ...
 */
var S2_Metric = (function () {
    /**
     * Defines a cell metric of the given dimension (1 == length, 2 == area).
     */
    function S2_Metric(_dim, _deriv) {
        this._dim = _dim;
        this._deriv = _deriv;
    }
    S2_Metric.prototype.deriv = function () {
        return this._deriv;
    };
    S2_Metric.prototype.dim = function () {
        return this._dim;
    };
    /** Return the value of a metric for cells at the given level. */
    S2_Metric.prototype.getValue = function (level) {
        return 0;
     ...
     */
    S2_Metric.prototype.getClosestLevel = function (/*double*/ value) {
     ...
     * valid level.
     */
    S2_Metric.prototype.getMinLevel = function (value /*double*/) {
        if (value <= 0) {
            return S2CellId_1.S2CellId.MAX_LEVEL;
        }
        // This code is equivalent to computing a floating-point "level"
        // value and rounding up.
        var exponent = S2.exp(value / ((1 << this.dim) * this.deriv));
        var level = Math.max(0, Math.min(S2CellId_1.S2CellId.MAX_LEVEL, -((exponent - 1) >> (this.dim - 1))));
     ...
     * valid level.
     */
    S2_Metric.prototype.getMaxLevel = function (value /*double*/) {
        if (value <= 0) {
            return S2CellId_1.S2CellId.MAX_LEVEL;
        }
        // This code is equivalent to computing a floating-point "level"
