...
private static S2_PROJECTION = Projections.S2_QUADRATIC_PROJECTION;
...
public static double stToUV(s:number):number {
  switch (S2Projections.S2_PROJECTION) {
    case Projection.S2_LINEAR_PROJECTION:
      return s;
