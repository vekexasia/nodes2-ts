...
// cells to be returned.
   ...
   */
  public getCovering(region:S2Region, covering:S2CellId[]) {
    ...
    const tmp = this.getCovering(region);
   ...
   */
  public getInteriorCovering(region:S2Region):S2CellId[] {
    S2CellUnion
    tmp = getInteriorCovering(region);
   ...
   */
  public  getCovering(region:S2Region):S2CellUnion {
    const covering = new S2CellUnion();
    getCovering(region, covering);
    return covering;
  }

  public getCovering(region:S2Region, covering:S2CellUnion) {
   ...
   */
  public getInteriorCovering(region:S2Region):S2CellUnion {
    const covering = new S2CellUnion();
    getInteriorCovering(region, covering);
    return covering;
  }

  public getInteriorCovering(region:S2Region, covering:S2CellUnion) {
