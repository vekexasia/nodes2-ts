...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", "./S2Cell", "./S2CellId", "./S2CellUnion", "./S2Projections", 'decimal.js'], factory);
    }
    ...
    var S2RegionCoverer = (function () {
        ...
        S2RegionCoverer.prototype.getInitialCandidates = function () {
            ...
            if (this.maxCells >= 4) {
                ...
                var level = Decimal.min(S2Projections_1.S2Projections.MIN_WIDTH.getMaxLevel(cap.angle().radians.times(2)), Decimal.min(this.maxLevel, S2CellId_1.S2CellId.MAX_LEVEL - 1)).toNumber();
